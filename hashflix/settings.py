...
SECRET_KEY = 'django-insecure-p+#fnq&*l$b-9%#cnt+7#5m1^ujx1*lth=m*@xkz_99k-n*(lp'
...
AUTH_USER_MODEL = "filme.Usuario" # Isso significa que dentro do app "filme" na classe usuario do models que vai gerenciar
